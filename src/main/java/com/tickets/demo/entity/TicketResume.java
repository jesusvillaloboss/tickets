...
@ToString
@NoArgsConstructor
@Table(name = "TICKET_RESUME")
public class TicketResume implements Cloneable {
    @Id
    ...
    @Override
    public TicketResume clone() {
        try {
            return (TicketResume) super.clone();
        } catch (CloneNotSupportedException e) {
            System.out.println("Error al clonar Resumen de Ticket ");
